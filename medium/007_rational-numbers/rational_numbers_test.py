...
class RationalNumbersTest(unittest.TestCase):
    ...
    def test_reduce_a_rational_number_with_both_negative_numerator_and_denominator(self):
        self.assertEqual(Rational(-36, -9), Rational(4, 1))
    ...
    # Test of type: Two rational is not equal

    def test_not_equal(self):
        self.assertNotEqual(Rational(1, 2), Rational(2, 2))

    def test_not_equal_after_being_reduced(self):
        self.assertNotEqual(Rational(5, 10), Rational(6, 10))
