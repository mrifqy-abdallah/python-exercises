...
# For simplicity, variables below are sorted just like the solution's table of zebra puzzle
# But even if you change the order, the code will still be able provide the correct answer
